...
Une mise en page définit la **structure visuelle** commune à un groupe de pages.

- **DefaultLayout** : en-tête en haut, contenu centré, pied de page en bas. Utilisé pour toutes les pages de l'application.
...
L'application se lance dans un conteneur Docker. Cela garantit un environnement identique pour tous, quel que soit le système utilisé.
